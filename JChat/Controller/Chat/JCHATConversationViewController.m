...
- (void)dropToolBar {
  ...
  [UIView animateWithDuration:0.3 animations:^{
    ...
    _moreViewContainer.moreView.hidden = YES;
    _moreViewContainer.collectionView.hidden = YES;
}
...
- (void)pressMoreBtnClick:(UIButton *)btn {
  ...
  [_toolBarContainer.toolbar.textView resignFirstResponder];
    ...
    if (btn.tag == 100) {
        ...
        _moreViewContainer.moreViewType = MV_FaceType;
    }else{
        _moreViewContainer.moreViewType = MV_FunctionType;
    }
